...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'https://websupportbd.com/subscription'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'websupportbd0live'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', '669656AD37E4146843'); // your store password.
}
