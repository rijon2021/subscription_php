...
<html lang="en">
    ...
    <body>
        <nav class="sb-topnav navbar navbar-dark bg-dark w-100">
            <!-- Navbar Brand-->
                <div><a class="navbar-brand ps-3" href="index.php">Registration and Login System</a></div>
                <div class="text-end pe-3">
                <a href="signin.html" class="btn btn-primary">Login Admin</a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                        <div class="mb-2">
                            <label for="firstName">SSC Registration No <span class="required-star">*</span></label>
                            <input type="text" name="ssc_roll" class="form-control" id="ssc_roll" placeholder="" required>
                        </div>
                        </div>
                        <div class="col-md-6">
                        <div class="mb-2">
                        ...
                        <button class="btn btn-primary mt-3"><i class="fa fa-search"></i> Search Student</button>
                        </div>
                        <div class="col-md-12">
                            ...
                            <table class="table table-bordered table-dark-bordered">
                                ...
                                <tr>
                                    ...
                                    <div id="ForLeftSideMenuList_divImage">
                                        <img class="img-responsive" style="width:80px;height:100px;"
                                        src="https://islampurcollege.edu.bd/Images/studentAdmissionImages/34852.Jpeg" alt="...">
                                    </div>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label ms-2" for="same-address"> I Agree with <a href="" class="text-info">Terms and
                            Comdition</a> </label>
                    </div>
                    <div class="text-center mt-3">
                        <button class="btn btn-info btn-lg btn-block" id="sslczPayBtn"><img class="me-2"
                            src="../../../../assets/images/theme/ssl-logo.png" alt=""> <strong> Pay Now</strong> </button>
                    </div>
                    </div>
