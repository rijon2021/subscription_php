...
$post_data['total_amount'] = 81;
$post_data['currency'] = "BDT";
// $post_data['tran_id'] = "WS".$idGenDate .$requestData['admission_no'];
$post_data['tran_id'] = "WS".time().mt_rand();

//# CUSTOMER INFORMATION
$post_data['cus_name'] =  $requestData['student_name'];
$post_data['cus_email'] =  $requestData['student_class'];
$post_data['cus_add1'] =  $requestData['admission_no'];
$post_data['cus_add2'] = $requestData['admission_year'];
$post_data['cus_city'] = $requestData['fathers_name'];
$post_data['cus_state'] = "Dhaka";
$post_data['cus_postcode'] = "1000";
$post_data['cus_country'] = "Bangladesh";
$post_data['cus_phone'] =  $requestData['student_mobile'];
$post_data['cus_fax'] = $requestData['category_id'];
